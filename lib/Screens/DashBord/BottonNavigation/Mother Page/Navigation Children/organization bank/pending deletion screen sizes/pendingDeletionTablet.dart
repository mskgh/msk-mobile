...
class PendingOrganizationTablet extends StatefulWidget {
  const PendingOrganizationTablet({super.key});

  @override
  State<PendingOrganizationTablet> createState() =>
      _PendingOrganizationTabletState();
}

class _PendingOrganizationTabletState extends State<PendingOrganizationTablet> {
  @override
  Widget build(BuildContext context) {
    ...
    if (deletedCards.isEmpty) {
      return const Center(
        child: Text(
          'No organization at pending deletion',
          style: TextStyle(
            fontSize: 15,
