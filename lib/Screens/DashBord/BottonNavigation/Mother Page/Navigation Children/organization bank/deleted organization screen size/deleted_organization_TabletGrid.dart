...
class DeletedOrganizationsPageTablet extends StatefulWidget {
  const DeletedOrganizationsPageTablet({super.key});

  @override
  State<DeletedOrganizationsPageTablet> createState() =>
      _DeletedOrganizationsPageTabletState();
}

class _DeletedOrganizationsPageTabletState extends State<DeletedOrganizationsPageTablet> {
  @override
